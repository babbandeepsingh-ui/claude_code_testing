...
<main>
        ...
        <div class="investor-relation-section-inner">
            ...
            <div class="section1 section-box" id="ir-home">
                <div class="left-section box">
                    <div class="left-section-inner">
                        ...
                        <a href="{{url('about-us-india')}}" class="btn btn--primary">Read More</a>
                    </div>
                </div>
            ...
            <div class="section2 section-box" id="ir-corporate">
                <div class="box1 box">
                    <div class="box-inner">
                        <div class="top-section">
                            <h3 class="title">Corporate Presentation</h3>
                            <span class="date">May 2021</span>
                        </div>
                        <div class="bottom-section">
                            <a href="{{asset('images/pdf/2021/Affle Presentation (May, 2021).pdf')}}" class="pdf-btn">
                                <span>Download PDF</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="15.663" viewBox="0 0 30 15.663"><path class="a" d="M28.463,44.668l-1.537-1.558-5.2,5.2V22.5H19.537V48.311l-5.2-5.2L12.8,44.668,20.632,52.5Z" transform="translate(-22.5 28.463) rotate(-90)"/></svg>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="box2 box">
                    <div class="box-inner">
                        <div class="top-section">
                            <h3 class="title">Annual Reports <span>& AGM Information</span></h3>
                        </div>
                        <div class="bottom-section">
                            <a href="{{url('annual-reports-agm-information')}}" class="pdf-btn">
            ...
            <div class="section3 section-box" id="ir-Annual">
                <div class="box1 box">
                    <div class="box-inner">
                        <div class="top-section">
                            <a href="{{url('corporate-governance')}}">
                                <h3 class="title">Corporate Policies <span>& Disclosures</span></h3>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="box2 box">
                    <div class="box-inner">
                        <div class="top-section">
                            <a href="{{url('esg-affle')}}">
                                <h3 class="title">ESG@affle</h3>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-content tab-content-child" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="fy22-q1" role="tabpanel" aria-labelledby="fy22-q1-tab">
                            <ul class="download-links">
                                <li><a href="{{asset('images/pdf/2021/IND AS Financial Results (Q1  FY2022).pdf')}}" target="_blank">Ind AS Financial Results</a></li>
                                <li><a href="{{asset('images/pdf/2021/Q1 FY2022 Earnings PPT.pdf')}}" target="_blank">Earnings Presentation</a></li>
                                <li><a href="{{asset('images/pdf/2021/Earnings Press Release Q1 FY2022.pdf')}}" target="_blank">Earnings Press Release</a></li>
                                <li><a href="{{asset('images/pdf/2021/Earnings Call Transcript - Q1 FY2022.pdf')}}" target="_blank">Earnings Call Transcript</a></li>
                                <!--li></li-->
                            </ul>
                        </div>
                ...
                <div class="tab-pane fade " id="pills-fy21" role="tabpanel" aria-labelledby="pills-fy21-tab">
                    ...
                    <div class="tab-content tab-content-child" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="fy21-q4" role="tabpanel" aria-labelledby="fy21-q4-tab">
                            <ul class="download-links">
                                <li><a href="{{asset('images/pdf/IND AS Financial Results (Q4 & 12M FY2021).pdf')}}" target="_blank">Ind AS Financial Results</a></li>
                                <li><a href="{{asset('images/pdf/Q4 & 12M FY2021 Earnings Presentation.pdf')}}" target="_blank"> Earnings Presentation </a></li>
                                <li><a href="{{asset('images/pdf/Earnings Press Release (Q4 & 12M FY2021).pdf')}}" target="_blank">Earnings Press Release</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Call Transcript - Q4 & 12M FY2021.pdf')}}" target="_blank">Earnings Call Transcript</a></li>
                            </ul>
                        </div>
                        <div class="tab-pane fade" id="fy21-q3" role="tabpanel" aria-labelledby="fy21-q3-tab">
                            <ul class="download-links">
                                <li><a href="{{asset('images/pdf/Ind AS Financial Results (Q3 & 9M FY2021).pdf')}}" target="_blank">Ind AS Financial Results</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Presentation (Q3 & 9M FY2021).pdf')}}" target="_blank">Earnings Presentation</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Press Release (Q3 & 9M FY2021).pdf')}}" target="_blank">Earnings Press Release</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Call Transcript - Q3 & 9M FY2021.pdf')}}" target="_blank">Earnings Call Transcript</a></li>
                            </ul>
                        </div>
                        <div class="tab-pane fade" id="fy21-q2" role="tabpanel" aria-labelledby="fy21-q2-tab">
                            <ul class="download-links">
                                <li><a href="{{asset('images/pdf/IND AS Financial Results (Q2 & H1 FY2021).pdf')}}" target="_blank">Ind AS Financial Results</a></li>
                                <li><a href="{{asset('images/pdf/Affle Earnings Presentation (Q2 & H1 FY2021).pdf')}}" target="_blank">Earnings Presentation</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Press Release (Q2 & H1 FY2021).pdf')}}" target="_blank">Earnings Press Release</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Call Transcript (Q2 & H1 FY2021).pdf')}}" target="_blank">Earnings Call Transcript</a></li>
                            </ul>
                        </div>
                        <div class="tab-pane fade" id="fy21-q1" role="tabpanel" aria-labelledby="fy21-q1-tab">
                            <ul class="download-links">
                                <li><a href="{{asset('images/pdf/Ind AS Financial Results (Q1 FY2021).pdf')}}" target="_blank">Ind AS Financial Results</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Presentation (Q1 FY2021).pdf')}}" target="_blank">Earnings Presentation</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Press Release (Q1 FY2021).pdf')}}" target="_blank">Earnings Press Release</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Call Transcript (Q1 FY2021).pdf')}}" target="_blank">Earnings Call Transcript</a></li>
                            </ul>
                        </div>
                ...
                <div class="tab-pane fade" id="pills-fy20" role="tabpanel" aria-labelledby="pills-fy20-tab">
                    ...
                    <div class="tab-content tab-content-child" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="fy20-q4" role="tabpanel" aria-labelledby="fy20-q4-tab">
                            <ul class="download-links">
                                <li><a href="{{asset('images/pdf/IND AS Financial Results (Q4 & 12M FY2020).pdf')}}" target="_blank">Ind AS Financial Results</a></li>
                                <li><a href="{{asset('images/pdf/Affle Earnings Presentation.pdf')}}" target="_blank">Earnings Presentation</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Press Release Q4 & 12M FY2020.pdf')}}" target="_blank">Earnings Press Release</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Call Transcript (Q4 & 12M FY2020).pdf')}}" target="_blank">Earnings Call Transcript</a></li>
                            </ul>
                        </div>
                        <div class="tab-pane fade" id="fy20-q3" role="tabpanel" aria-labelledby="fy20-q3-tab">
                            <ul class="download-links">
                                <li><a href="{{asset('images/pdf/Ind AS Financial Results (Q3 & 9M FY2020).pdf')}}" target="_blank">Ind AS Financial Results</a></li>
                                <li><a href="{{asset('images/pdf/Affle Earnings Presentation Q3 & 9M FY2020.pdf')}}" target="_blank">Earnings Presentation</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Press Release Q3 & 9M FY2020.pdf')}}" target="_blank">Earnings Press Release</a></li>
                                <li><a href="{{asset('images/pdf/Affle Earnings Call Transcript - Q3 & 9M FY2020.pdf')}}" target="_blank">Earnings Call Transcript</a></li>
                            </ul>
                        </div>
                        <div class="tab-pane fade" id="fy20-q2" role="tabpanel" aria-labelledby="fy20-q2-tab">
                            <ul class="download-links">
                                <li><a href="{{asset('images/pdf/Ind AS Financial Results (Q2 & H1 FY2020).pdf')}}" target="_blank">Ind AS Financial Results</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Presentation Q2 & H1 FY2020.pdf')}}" target="_blank"> Earnings Presentation</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Press Release Q2 & H1 FY2020.pdf')}}" target="_blank">Earnings Press Release</a></li>
                                <li><a href="{{asset('images/pdf/Earnings Call Transcript - Q2 & H1 FY2020.pdf')}}" target="_blank">Earnings Call Transcript</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="box">
                        <div class="box-inner">
                            <div class="title-filter">
                                ...
                                <div class="filter">
                                    <select class="filter-event filter-event-investor">
                            ...
                            <div class="box-section filter-content-investor">
                            <div class="box-item" filter-value="2021">
                                    <div class="content">
                                        <a href="{{asset('images/pdf/2021/Analyst & Investor Meet - Intimation (September 1, 2021).pdf')}}" target="_blank">
                                            <span class="date">1 Sep 2021</span>
                                ...
                                <div class="box-item" filter-value="2021">
                                    <div class="content">
                                        <a href="{{asset('images/pdf/2021/Analyst & Investor Meet - Intimation (August 26, 2021).pdf')}}" target="_blank">
                                ...
                                <div class="box-item hidden" filter-value="2020">
                                    <div class="content">
                                ...
                                <div class="box-item hidden" filter-value="2019">
                                    <div class="content">
                    ...
                    <div class="box">
                        <div class="box-inner">
                            <div class="title-filter">
                                ...
                                <div class="filter">
                                    <select class="filter-event filter-event-other">
                                        <option value="other-2021">2021</option>
                                        <option value="other-2020">2020</option>
                                        <option value="other-2019">2019</option>
                                    </select>
                                </div>
                            </div>
                            <div class="box-section filter-content-other">
                            <div class="box-item" filter-value="other-2021">
                                    <div class="content">
                                        <a href="{{asset('images/AGM Notice & Annual Report Newspaper Publication - Aug 31,2021.pdf')}}" target="_blank">
                                ...
                                <div class="box-item" filter-value="other-2021">
                                    <div class="content">
                                        <a href="{{asset('images/Board Meeting outcome (August 26, 2021).pdf')}}" target="_blank">
                                            <span class="date">26 Aug 2021</span>
                                ...
                                <div class="box-item" filter-value="other-2021">
                                    <div class="content">
                                        <a href="{{asset('images/Notice of Board Meeting (August 23, 2021).pdf')}}" target="_blank">
                                ...
                                <div class="box-item hidden" filter-value="other-2020">
                                    <div class="content">
                                ...
                                <div class="box-item hidden" filter-value="other-2019">
                                    <div class="content">
    ...
    <section class="investor-faqs-section">
        <div class="investor-faqs-section-inner"  id="faqs-sec">
