...
<main>
    ...
    <section class="contact-section1 innerpage-padding thankyou-page">
        <div class="contact-section1-inner">
            <div class="form-section thankyou-section">
                <div class="thankyou-section-inner">
                    <div class="content">
                        <div class="icon">
                            <img src="{{asset('images/green-check.png')}}" alt="Singapore" class="img-fluid" loading="lazy">
                        </div>
                        <h3 class="title">Thank You!</h3>
                        <p>For taking interest in our services. We shall soon get in touch!</p>
                        <a href="{{url('contact')}}" class="btn">Submit Another Query</a>
                    </div>
                    <div class="content-bottom">
                        <div class="content-bottom-inner">
                            <span class="text">Do browse the rest of our website.</span>
